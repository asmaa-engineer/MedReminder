    ...
    <div className="min-h-screen bg-gray-50 pb-32">
      ...
      <div className="px-6 py-8">
        <div className="flex flex-col items-center mb-8">
          <div className="w-24 h-24 bg-blue-600 rounded-[32px] flex items-center justify-center text-white shadow-xl shadow-blue-100 mb-4">
            <Pill size={48} />
          </div>
          <h2 className="text-3xl font-bold text-gray-900">{med.name}</h2>
          <p className="text-gray-500 font-medium">{med.dose} • {med.freq}</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          ...
          <GlassCard className="p-4 bg-white border-none shadow-sm">
            ...
            <p className="font-bold">{med.stock}/{med.total}</p>
          </GlassCard>
        </div>
        ...
        <section className="mb-8">
          ...
          <GlassCard className="bg-white border-none shadow-sm p-5">
            <p className="text-sm text-gray-600 leading-relaxed">{med.instructions}</p>
          </GlassCard>
        </section>
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="flex-1 rounded-2xl h-14 border-gray-100 text-gray-600 font-bold">
            <Archive size={20} className="mr-2" /> Archive
          </Button>
          <Button className="flex-1 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl h-14 font-bold shadow-lg shadow-blue-100">
            Log Dose Now
          </Button>
        </div>
      </div>
